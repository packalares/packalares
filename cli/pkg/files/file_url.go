...
var (
	...
	MinioOperatorUrl = "https://github.com/minio/operator/releases/download/v%s/minio-operator-v%s-linux-%s.tar.gz"

	RedisUrl = "%s/%s"

	JuiceFsUrl = "https://github.com/beclab/juicefs-ext/releases/download/%s/juicefs-%s-linux-%s.tar.gz"

	VeleroUrl = "https://github.com/vmware-tanzu/velero/releases/download/%s/velero-%s-linux-%s.tar.gz"
