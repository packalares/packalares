	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SysV1().Backups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SysV1().Backups(namespace).Watch(context.TODO(), options)
			},
		},
		&sysbytetradeiov1.Backup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sysbytetradeiov1.Backup{}, f.defaultInformer)
}
