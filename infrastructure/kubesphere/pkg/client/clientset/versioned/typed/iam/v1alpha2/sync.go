...
type SyncInterface interface {
	Create(ctx context.Context, sync *v1alpha2.Sync, opts v1.CreateOptions) (*v1alpha2.Sync, error)
	Update(ctx context.Context, sync *v1alpha2.Sync, opts v1.UpdateOptions) (*v1alpha2.Sync, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.Sync, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.SyncList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Sync, err error)
	SyncExpansion
}
...
func newSyncs(c *IamV1alpha2Client) *syncs {
	return &syncs{
		client: c.RESTClient(),
	}
}
...
func (c *syncs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Sync, err error) {
	result = &v1alpha2.Sync{}
	err = c.client.Get().
		Resource("syncs").
		Name(name).
...
func (c *syncs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.SyncList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.SyncList{}
	err = c.client.Get().
		Resource("syncs").
...
func (c *syncs) Create(ctx context.Context, sync *v1alpha2.Sync, opts v1.CreateOptions) (result *v1alpha2.Sync, err error) {
	result = &v1alpha2.Sync{}
	err = c.client.Post().
		Resource("syncs").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *syncs) Update(ctx context.Context, sync *v1alpha2.Sync, opts v1.UpdateOptions) (result *v1alpha2.Sync, err error) {
	result = &v1alpha2.Sync{}
	err = c.client.Put().
		Resource("syncs").
		Name(sync.Name).
...
func (c *syncs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Sync, err error) {
	result = &v1alpha2.Sync{}
