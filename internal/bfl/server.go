...
func (s *Server) registerRoutes() {
	...
	s.mux.HandleFunc("/api/settings/vpn/status", s.handleVPNStatus)
	s.mux.HandleFunc("/api/settings/vpn/wireguard/enable", s.handleWireGuardEnable)
	s.mux.HandleFunc("/api/settings/vpn/wireguard/disable", s.handleWireGuardDisable)
	s.mux.HandleFunc("/api/settings/vpn/tailscale/disable", s.handleTailscaleDisable)
