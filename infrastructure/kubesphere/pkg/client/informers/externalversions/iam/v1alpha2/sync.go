	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IamV1alpha2().Syncs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IamV1alpha2().Syncs().Watch(context.TODO(), options)
			},
		},
		&iamv1alpha2.Sync{},
		resyncPeriod,
...
func (f *syncInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&iamv1alpha2.Sync{}, f.defaultInformer)
}

func (f *syncInformer) Lister() v1alpha2.SyncLister {
	return v1alpha2.NewSyncLister(f.Informer().GetIndexer())
}
